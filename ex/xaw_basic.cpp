...
/*
 * $XConsortium: xwidgets.c,v 1.29 91/01/22 20:02:39 gildea Exp $
 *
...
static void
CreateFormWithButtons(Widget parent);
static void
CreateBox(Widget parent);
static void 
Syntax(XtAppContext app_con, char* call);
static void 
TimeSinceTouched(Widget widget,XtPointer closure, XtPointer value_ptr);
static void 
Quit(Widget widget,XtPointer closure,XtPointer callData);
static void 
Count(Widget widget, XtPointer closure, XtPointer callData);
static void 
Okay(Widget widget, XtPointer clientData, XtPointer callData);
static void 
Scrolled(Widget widget, XtPointer label_ptr, XtPointer value_ptr);
static void 
Thumbed(Widget widget, XtPointer label_ptr, XtPointer top_ptr);
static void
Finish(XtPointer client_data, XtIntervalId id);
static void 
Destroyed(Widget widget, XtPointer closure, XtPointer callData);
...
Scrolled(Widget widget, XtPointer label_ptr, XtPointer value_ptr)
{
    int value = reinterpret_cast<intptr_t>(value_ptr);
